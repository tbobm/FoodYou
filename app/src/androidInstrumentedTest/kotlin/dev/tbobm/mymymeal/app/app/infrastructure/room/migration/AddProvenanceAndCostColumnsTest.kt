...
class AddProvenanceAndCostColumnsTest : AbstractAddProvenanceAndCostColumnsTest() {
    private val instrumentation = InstrumentationRegistry.getInstrumentation()
    private val file =
        instrumentation.targetContext.getDatabasePath("AddProvenanceAndCostColumnsTest.db")
